...
// DeCompiled : Multiplotsameframe.class
//package CGRexpack;
//import java.awt.Container;
//import javax.swing.JTextPane;

class Multiplotsameframe
{
	// CGRexMainGUI obj;
     CGRDrawing jpanel1;
     CGRDrawing jpanel2;
     Multiplot multiplot;
    public Multiplotsameframe(CGRexMainGUI maingui, CGRDrawing drawingclass, CGRDrawing drawingclass1)
    {
       // obj = null;
       // jpanel1 = null;
       // jpanel2 = null;
       // obj = maingui;
    	if(maingui.SeqFile != null)
    	{	
    	drawingclass.splitPlot(0);
        ...
        String as[] = {
            "Corners:" + drawingclass.getTestCorners(),"Sequence Type:" + drawingclass.getTestSeqType(), "File Name :"+maingui.SeqFile.getName(),"_Points Assignment"
        };
        ...
        String as3[] = {
            "Corners:" + drawingclass1.getTestCorners(), "Sequence Type:" + drawingclass1.getTestSeqType(),"File Name :"+maingui.multiSeqfile.getName(),"_Points Assignment"
        };
        ...
        maingui.getContentPane().add(maingui.drawing1);
    	...
    	else
    	{
            ...
            maingui.Sequencepanel2.seq.setText(drawingclass1.getTestSeqStr());
            String as[] = {
                "Corners:" + drawingclass.getTestCorners(),"Sequence Type:" + drawingclass.getTestSeqType(), "File Name : Not specified","_Points Assignment"
            };
            String as1[] = drawingclass.getTestDistribution();
            String as2[] = new String[as.length + as1.length];
            for(int i = 0; i < as.length; i++)
            ...
            maingui.Settingspanel1 = new settingsPanel("Settings", as2, 0, 530, 398, 140);
            String as3[] = {
                "Corners:" + drawingclass1.getTestCorners(), "Sequence Type:" + drawingclass1.getTestSeqType(),"File Name : Not Specified","_Points Assignment"
            };
            String as4[] = drawingclass1.getTestDistribution();
            String as5[] = new String[as3.length + as4.length];
            for(int k = 0; k < as3.length; k++)
